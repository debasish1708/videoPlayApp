...
@section('title', 'User Creation - Forms')
    ...
    <div class="card mb-6">
      ...
      <form class="card-body" action="{{ route('users.store') }}" method="POST">
        ...
        <div class="row mb-6">
          ...
          <div class="col-sm-9">
            <input type="text" id="multicol-username" class="form-control" name="user_name" value="{{ old('user_name') }}" placeholder="john.doe" />
            @error('user_name')
        ...
        <div class="row mb-6">
          ...
          <div class="col-sm-9">
            <div class="input-group input-group-merge">
              <input type="text" id="multicol-email" class="form-control" name="email" value="{{ old('email') }}" placeholder="john.doe@gmail.com" />
              @error('email')
        ...
        <div class="row mb-6">
          ...
          <div class="col-sm-9">
            <input type="text" id="multicol-full-name" class="form-control" name="name" placeholder="John Doe" />
            @error('name')
        ...
        <div class="row mb-6 select2-primary">
            ...
            <div class="col-sm-9">
                ...
                $selectedLanguages = old('language', []);
                @endphp
        ...
        <div class="row mb-6">
          ...
          <div class="col-sm-9">
            <input type="text" id="flatpickr-date" class="form-control dob-picker" name="date_of_birth" value="{{ old('date_of_birth') }}" placeholder="YYYY-MM-DD" />
            @error('date_of_birth')
        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            <input type="text" id="multicol-phone" class="form-control phone-mask" name="mobile_number" placeholder="658 799 8941" aria-label="658 799 8941" />
            @error('mobile_number')
